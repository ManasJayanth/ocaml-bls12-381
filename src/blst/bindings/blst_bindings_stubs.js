...
//Provides: allocate_fr_stubs
//Requires: Blst_fr
function allocate_fr_stubs(unit) {
  return new Blst_fr();
}
...
function caml_blst_fp2_cneg_stubs(buffer, p, b) {
  wasm_call("_blst_fp2_cneg", Blst_fp2_val(buffer), Blst_fp2_val(p), b);
  return 0;
}
...
function caml_blst_fp2_of_bytes_components_stubs(buffer, x1, x2) {
  var buffer_c = Blst_fp2_val(buffer);
  wasm_call("_blst_fp2_of_bytes_components", buffer_c, x1, x2);
  return 0;
}
...
//Provides: caml_blst_signature_keygen_stubs
//Requires: wasm_call
//Requires: Blst_scalar_val
//Requires: integers_int32_of_uint32
...
//Provides: caml_blst_sk_to_pk_in_g1_stubs
//Requires: wasm_call
...
//Provides: caml_blst_sign_pk_in_g1_stubs
//Requires: wasm_call
...
//Provides: caml_blst_pairing_commit_stubs
//Requires: wasm_call
//Requires: Blst_pairing_val
...
//Provides: caml_blst_pairing_finalverify_stubs
//Requires: wasm_call
//Requires: Blst_pairing_val
...
//Provides: caml_blst_pairing_chk_n_mul_n_aggr_pk_in_g1_stubs
//Requires: wasm_call
...
//Provides: caml_blst_sk_to_pk_in_g2_stubs
//Requires: wasm_call
//Requires: Blst_p2_val, Blst_scalar_val
...
//Provides: caml_blst_sign_pk_in_g2_stubs
//Requires: wasm_call
//Requires: Blst_p1_val, Blst_scalar_val
...
//Provides: caml_blst_aggregate_signature_stubs
//Requires: wasm_call
//Requires: Blst_pairing_val
//Requires: integers_int32_of_uint32
function caml_blst_aggregate_signature_stubs(
  buffer,
  msg,
  msg_length,
  dst,
...
//Provides: caml_blst_aggregate_signature_stubs_bytecode
function caml_blst_aggregate_signature_stubs_bytecode(
  buffer,
  msg,
  msg_length,
  dst,
  ...
  return caml_blst_aggregate_signature_stubs(
    buffer,
    msg,
    msg_length,
    dst,
